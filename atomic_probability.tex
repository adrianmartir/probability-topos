...
\begin{definition} \label{U-notation}
\begin{enumerate}
...
\item When denoting the presheaf $y U_{r_i}$, this will be interpreted as the functor sending a finite probability space $(X,\mu)$ to the set its partitions $(a_i)$ of the set $X$ with $\mu(a_i) = r_i$.
...
As promised, this is notation for finite probability spaces in the sense that the $U_{r_i}$ form a skeleton of $FinProb$. Part (ii) of the definition is reasonable, since a morphism $(X,\mu) \to U_{r_i}$ of finite probability spaces consists precisely of a partition $(a_i)_i$ of $(X,\mu)$ into subsets of measure $r_i$.
