...
\]
where $c$ is of the sort $U_{r_{ij}}$ and $f$ and $g$ are the canonical maps projecting onto the correct indices. But this last sequent is easily to hold by setting $c_{ij} := a_i \wedge b_j$.
