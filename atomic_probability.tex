...
\begin{proof}
    ...
    \begin{enumerate}
        ...
        In order to show that this multiproduct gets preserved, we need to show that the map
        \[
        ...
        \end{tikzcd}
        be a diagram in $FinProb$. We show that $F$ preserves multiequalizers. More specifically, if we have a family of forks
        \[
            \begin{tikzcd}
            \gamma_i \arrow[r, "h_i"] & \alpha \arrow[r, "f", shift left] \arrow[r, "g"', shift right] & \beta
            \end{tikzcd}
        \]
        forming a multiequalizer, then we need to show that
        \[
        ...
        We already know that multiequalizers in $FinProb$ are particularly simple. If $f = g$, then the family of forks consists of only the identity map $id: \alpha \to \alpha$. In this case our claim becomes trivial.

        Now assume that $f \neq g$. Then the multiequalizer is the empty family. Thus our claim becomes that
        \[
            eq(\begin{tikzcd}
