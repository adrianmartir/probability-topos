...
\begin{proposition}
    We have that
    \[
        \mathcal{S} \cong \langle \{y_1 < \cdots < y_n \mid y_i \in \mathbb{R} \} \mid (r_1, \cdots, r_n) \in \mathcal{A} \rangle
    \]
...
\begin{align*}
    S \times S &\cong \langle \{y_1 < \cdots < y_n \mid y_i \in \mathbb{R} \} \mid (r_1, \cdots, r_n) \in \mathcal{A} \rangle^2 \\
    &\cong \langle \{y_1 < \cdots < y_n, z_1 < \cdots < z_m \mid y_i, z_j \in \mathbb{R} \} \mid (t_{ij})_{1 \leq i \leq n, 0 \leq j \leq m} \in \mathcal{A}\rangle
\end{align*}
...
\begin{proposition}
    \begin{enumerate}
        ...
        \[
            \langle \{y_1 < \cdots < y_n \mid y_i \in \mathbb{R}, \sum r_i y_i = r \} \mid (r_1, \cdots, r_n) \in \mathcal{A} \rangle
        \]
        of $\mathcal{S}$.
    \end{enumerate}
\end{proposition}
