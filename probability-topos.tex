...
\begin{proof}
    ...
    \begin{enumerate}
        ...
        \item We check the sheaf condition \ref{sheaf_condition_weak} for a coproduct of representables. But since we already know this sheaf condition holds for representables, we merely need to note that equalizers of coproducts are coproducts of equalizers in presheaf toposes (since this fact can be checked pointwise in set).
    \end{enumerate}
\end{proof}
